...
public class NormalUser extends User {
    ...
    // This is the implementation of a `NormalUser` class that extends the `User`
    // class. It has two
    // private instance variables `booksBought` and `magazinesSubscribed` which are
    // ArrayLists of
    // `Book` and `Magazine` objects respectively. The constructor initializes these
    // ArrayLists as
    // empty.
    public NormalUser(String name, String id, String joinDate) {
